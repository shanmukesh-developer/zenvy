         ...
         <div className="grid grid-cols-3 gap-4 mb-12 relative animate-in fade-in slide-in-from-bottom-8 duration-1000" style={{ animationFillMode: 'both', animationDelay: '250ms' }}>
            {[
              ...
              <Tilt key={i} scale={1.05}>
                <div className="bg-black/40 backdrop-blur-xl border border-white/5 rounded-[24px] md:rounded-[32px] p-2 sm:p-4 md:p-5 py-5 md:py-6 flex flex-col items-center justify-center text-center gap-2 md:gap-3 hover:bg-white/[0.08] hover:border-primary-yellow/30 transition-all duration-500 group h-full">
                   ...
                   <span className="text-[7px] sm:text-[10px] uppercase tracking-[0.1em] sm:tracking-[0.25em] font-black text-white/40 group-hover:text-white/70 transition-colors leading-tight whitespace-pre">{attr.label}</span>
                </div>
              </Tilt>
            ))}
         </div>
