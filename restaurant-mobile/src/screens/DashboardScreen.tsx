    ...
    <View style={[styles.orderCard, isPending ? styles.cardPending : isAccepted ? styles.cardAccepted : {}]}>
      <View style={styles.cardHeader}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
           <Ionicons name={isPending ? 'time-outline' : isAccepted ? 'flame-outline' : 'checkmark-circle-outline'} size={16} color={isPending ? '#FBBF24' : isAccepted ? '#60A5FA' : '#10B981'} />
           <Text style={styles.orderId}>#{orderId}</Text>
        </View>
        <Text style={[styles.orderStatus, isPending ? {color: '#FBBF24'} : isAccepted ? {color: '#60A5FA'} : {color: '#10B981'}]}>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        <Text style={{ color: '#9CA3AF', fontSize: 12, fontWeight: '700' }}>TOTAL</Text>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={{ flex: 1 }}>
          <Text style={styles.title}>KDS <Text style={{ color: '#10B981' }}>LIVE</Text></Text>
          <Text style={styles.subtitle} numberOfLines={1}>{restaurantData.name || 'Zenvy Elite Kitchen'}</Text>
        </View>
        <View style={styles.controls}>
          <View style={styles.networkBadge}>
             <View style={[styles.networkDot, { backgroundColor: isConnected ? '#10B981' : '#DC2626' }]} />
          ...
          <View style={styles.autoAcceptWrapper}>
            ...
            <Switch 
              ...
              thumbColor={autoAccept ? '#10B981' : '#f4f3f4'}
            />
          </View>
        </View>
      </View>
      ...
      {loading ? (
         ...
         <View style={styles.emptyState}>
            <Ionicons name="restaurant-outline" size={64} color="#1F2937" />
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, paddingBottom: 20, paddingTop: 60, backgroundColor: '#12121A', borderBottomWidth: 1, borderBottomColor: '#1F2937' },
  title: { fontSize: 28, fontWeight: '900', color: '#FFF', letterSpacing: 1 },
  subtitle: { fontSize: 13, color: '#9CA3AF', fontWeight: '800', marginTop: 2, textTransform: 'uppercase', letterSpacing: 2 },
  controls: { alignItems: 'flex-end', gap: 12 },
  networkBadge: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(255,255,255,0.05)', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 12 },
  networkDot: { width: 6, height: 6, borderRadius: 3 },
  networkText: { color: '#9CA3AF', fontSize: 9, fontWeight: '900', letterSpacing: 1 },
  autoAcceptWrapper: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: 'rgba(255,255,255,0.03)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20, borderWidth: 1, borderColor: '#1F2937' },
  autoAcceptLabel: { color: '#FFF', fontSize: 10, fontWeight: '900', letterSpacing: 1 },
  grid: { padding: 16, gap: 16 },
  orderCard: { backgroundColor: '#12121A', borderRadius: 20, padding: 20, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)', shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.3, shadowRadius: 15, elevation: 5 },
  cardPending: { borderColor: '#F59E0B', backgroundColor: '#181512' },
  cardAccepted: { borderColor: '#3B82F6', backgroundColor: '#10151C' },
  cardHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 16, alignItems: 'center' },
  orderId: { color: '#FFF', fontSize: 18, fontWeight: '900', letterSpacing: 1 },
  orderStatus: { fontSize: 11, fontWeight: '900', letterSpacing: 2 },
  customerName: { color: '#9CA3AF', fontSize: 14, fontWeight: '700', marginBottom: 8 },
  ...
  itemQty: { color: '#10B981', fontSize: 14, fontWeight: '900' },
  itemText: { color: '#F3F4F6', fontSize: 15, fontWeight: '600', flex: 1 },
  price: { color: '#10B981', fontSize: 24, fontWeight: '900' },
  actions: { flexDirection: 'row', gap: 12 },
  acceptBtn: { flex: 1, backgroundColor: '#F59E0B', paddingVertical: 16, borderRadius: 12, alignItems: 'center', shadowColor: '#F59E0B', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 4 },
  readyBtn: { flex: 1, backgroundColor: '#3B82F6', paddingVertical: 16, borderRadius: 12, alignItems: 'center', shadowColor: '#3B82F6', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 4 },
  ...
  emptyTitle: { fontSize: 20, fontWeight: '900', color: '#FFF', marginTop: 16, letterSpacing: 1 },
